...
CREATE TABLE `expenses` (
  ...
  `current_revenues` double(15,2) DEFAULT NULL,
  `new_revenues` double(15,2) DEFAULT NULL,
  `current_funds` double(15,2) DEFAULT NULL,
  `new_funds` double(15,2) DEFAULT NULL,
  `type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `deduct_from` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2024-03-02  0:21:40
