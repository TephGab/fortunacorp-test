...
CREATE TABLE `system_bank_accounts` (
  ...
  `currency` set('us','htg','pesos') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'us',
  ...
  PRIMARY KEY (`id`),
  KEY `system_bank_accounts_user_id_foreign` (`user_id`),
  CONSTRAINT `system_bank_accounts_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `system_bank_accounts`
--

LOCK TABLES `system_bank_accounts` WRITE;
/*!40000 ALTER TABLE `system_bank_accounts` DISABLE KEYS */;
/*!40000 ALTER TABLE `system_bank_accounts` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-03-18  0:13:30
