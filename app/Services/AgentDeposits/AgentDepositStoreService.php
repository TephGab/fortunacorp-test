...
class AgentDepositStoreService
{
    public function agentDepositStore($request, $user, $envoy, $systemAccount)
    {
        ...
        switch ($request->deposit_type) {
            case $request->deposit_type == 'user_account':
                ...
                try {
                    ...
                    $deposit->amount = $request->dept_amount_deposit;
                    ...
                    $deposit->operation = 'investment';
                    $deposit->save();
                    // End Store Agent deposit
    
                    // Set Deposit History
                    $deposit_history = new AgentDepositActivit;
                    ...
                    $deposit_history->agent_deposit_id = $deposit->id;
                    ...
                    DB::commit();
                    //Create Envent
                    event(new AgentDepositEvent($deposit, $user));
